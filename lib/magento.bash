magento::__module__() {
  ...
  MAGENTO_DB_DUMP_TABLES_IGNORE="${MAGENTO_DB_DUMP_TABLES_IGNORE:-}"

  # Tables for which data will not be dumped only schema
  MAGENTO_DB_DUMP_TABLES_SKIP_DATA="${MAGENTO_DB_DUMP_TABLES_SKIP_DATA:-
  ...
  MAGENTO_CODE_DUMP_EXCLUDE_PATTERNS="${MAGENTO_CODE_DUMP_EXCLUDE_PATTERNS:-
    ./var
    ./pub/media
  }"

  MAGENTO_MEDIA_DUMP_EXCLUDE_PATTERNS="${MAGENTO_MEDIA_DUMP_EXCLUDE_PATTERNS:-
    pub/media/tmp
    pub/media/cache
    pub/media/.thumbs
    pub/media/.thumbs*
